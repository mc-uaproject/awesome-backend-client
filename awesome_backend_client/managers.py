...
class UserManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add user-specific custom methods"""

        async def me(self) -> dict[str, Any]:
            """Get current user"""
            return await self.client.http.get("/auth/me")
        ...
        self.me = me
        self.search_by_nickname = search_by_nickname
        self.set_minecraft_nickname = set_minecraft_nickname
...
class RoleManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add role-specific custom methods"""
        ...
        self.get_assignable = get_assignable
...
class ApplicationManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add application-specific custom methods"""
        ...
        async def get_count(self, **filters) -> dict[str, Any]:
            ...
            return await self.client.http.get(
                "/applications/list/count", params=filters
            )

        async def search(self, **params) -> list[dict[str, Any]]:
            """Search applications"""
            return await self.client.http.get(
                "/applications/list/search", params=params
            )
        ...
        self.get_evervault = get_evervault
        self.get_v2 = get_v2
        self.get_count = get_count
        self.search = search
        self.submit_section = submit_section
...
class ApplicationSectionManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add application section-specific custom methods"""
        ...
        self.get_by_application = get_by_application
        self.get_by_application_and_server = get_by_application_and_server
...
class ClaimManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add claim-specific custom methods"""
        ...
        self.get_by_claimant = get_by_claimant
        self.get_by_defendant = get_by_defendant
        self.get_by_status = get_by_status
        self.get_judging = get_judging
...
class TicketManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add ticket-specific custom methods"""
...
class WebhookManager(BaseCRUDManager):
    ...
    def _add_custom_methods(self):
        """Add webhook-specific custom methods"""
        self._add_basic_methods()
        self._add_status_methods()
        self._add_bulk_methods()
        self._add_log_methods()

    def _add_basic_methods(self):
        """Add basic webhook methods"""
        ...
        self.test = test
        self.get_by_status = get_by_status
        self.get_by_endpoint = get_by_endpoint

    def _add_status_methods(self):
        """Add webhook status management methods"""
    ...
    def _add_bulk_methods(self):
        """Add bulk webhook management methods"""
        ...
        self.bulk_activate = bulk_activate
        self.bulk_deactivate = bulk_deactivate

    def _add_log_methods(self):
        """Add webhook log management methods"""
        ...
        async def get_failed_logs(
            ...
            return await self.get_logs(
                webhook_id=webhook_id, status="failed", limit=limit
            )
        ...
        self.get_failed_logs = get_failed_logs
